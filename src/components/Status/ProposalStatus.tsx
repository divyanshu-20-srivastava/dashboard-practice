  ...
  <div className="border rounded-2xl p-4 bg-white shadow-sm relative">
    <div className="flex justify-between items-start mb-4">
      <div>
        ...
        <p className="text-sm text-gray-500 font-monster">{product.quantity}</p>
      </div>
    ...
    <div className="relative aspect-[4/3] mb-4">
      ...
      {/* Status Badge */}
      <span className="absolute font-monster top-2 right-2 inline-flex items-center rounded-full bg-white px-3 py-1 text-[10px] font-medium text-yellow-500 shadow-sm">
        {product.status}
      </span>
    </div>
    ...
    <div>
      ...
      <p className="text-sm font-normal text-gray-500 font-monster">
        {product.note}
      </p>
    </div>
  </div>
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow">
      ...
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-semibold font-playfair">Proposal Status</h2>
